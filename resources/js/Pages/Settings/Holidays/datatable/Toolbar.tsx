      ...
      >
        <div className="flex shrink-0 gap-2">
          <Input
            ...
            onChange={(e) => {
              ...
              // Filter holidays locally since we're not using server-side pagination yet
              // This can be updated later if backend supports pagination
            }}
            prefix={<MagnifyingGlassIcon className="size-4" />}
            placeholder={t('common.search_holidays') || 'Search holidays...'}
            classNames={{
              root: "shrink-0",
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {!smAndDown && <span>{t('common.add_holiday') || 'Add Holiday'}</span>}
          </Button>
