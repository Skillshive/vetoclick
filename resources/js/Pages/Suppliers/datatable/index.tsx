...
import { SuppliersDatatableProps } from "./types";
import { createColumns } from "./columns";
import { Toolbar } from "./Toolbar";
import { useSuppliersTable } from "./hooks";

const isSafari = getUserAgentBrowser() === "Safari";

export default function SuppliersDatatable({ suppliers: suppliersData, filters }: SuppliersDatatableProps) {
  ...
  const {
    ...
    initialData: suppliersData.data,
    initialFilters: filters,
  });

  // Create columns with modal handlers
  const columns = createColumns({ setSelectedSupplier, setIsModalOpen });
  ...
  useDidUpdate(() => table.resetRowSelection(), [suppliers]);
  ...
  return (
    ...
    <ConfirmModal
      ...
      messages={{
        pending: {
          description: `Are you sure you want to delete ${table.getSelectedRowModel().rows.length} selected suppliers? Once deleted, they cannot be restored.`,
        },
        success: {
          title: "Suppliers Deleted",
          description: `Successfully deleted ${table.getSelectedRowModel().rows.length} suppliers.`,
        },
      }}
