...
'breed_name_invalid_chars' => 'Breed name contains invalid characters.',
    ...
    'first_name_string' => 'The first name must be a valid text.',  
    'first_name_max' => 'The first name must not exceed 50 characters.',  
    'first_name_unique' => 'The first name has already been taken.',  
    'last_name_string' => 'The last name must be a valid text.',  
    'last_name_max' => 'The last name must not exceed 50 characters.',  
    'last_name_unique' => 'The last name has already been taken.',  
    'email_string' => 'The email must be a valid email address.',  
    'email_max' => 'The email must not exceed 255 characters.',  
    'phone_string' => 'The phone number must be a valid phone number.',  
    'phone_max' => 'The phone number must not exceed 20 characters.',  
    'phone_regex' => 'The phone number must be a valid phone number. (e.g. +212 611223344)',  
