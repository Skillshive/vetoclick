...
class AppointmentReminder extends Notification implements ShouldBroadcastNow
{
    use Queueable;
     ...
     */
    public function __construct(Appointment $appointment, string $reminderTime = '1 hour')
    {
    ...
    {
        // Use the user.{userId} channel for the client
        $userId = $this->appointment->client && $this->appointment->client->user 
            ? $this->appointment->client->user->id 
            : null;
